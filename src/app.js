...
y disponga de dos grupos de rutas: /products y /carts. 
Dichos endpoints estarán implementados con el router de express, con las siguientes especificaciones:
		...
		- La ruta raíz POST / deberá agregar un nuevo producto con los campos:
				* id: Number/String --> (OBLIGATORIO)
							(A tu elección, el id NO se manda desde body, 
				...
				* status:Boolean (true por defecto) --> (OBLIGATORIO)
				* stock:Number --> (OBLIGATORIO)
				* category:String --> (OBLIGATORIO)
				* thumbnails: --> (NO OBLIGATORIO)
							(Array de Strings que contenga las rutas donde 
